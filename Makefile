...
GO_PKG=github.com/shengzhihao1996/prometheus-operator
...
#GO_BUILD_RECIPE=GOOS=linux CGO_ENABLED=0 go build -mod=vendor -ldflags="-s -X /home/szh/learn/go/src/prometheus-operator/pkg/"
